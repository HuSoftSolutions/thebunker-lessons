    ...
    <div>
      ...
      <section className="bg-black bg-opacity-90 flex flex-wrap gap-6 justify-center p-10">
        ...
        <ProfileCard
          ...
          image=""
        />
        <ProfileCard name="Brandon Risler" title="-" bio="Brandon has been in the golf industry for over 10 years as an assistant golf professional, most recently at Saratoga Golf and Polo. Brandon is working toward his PGA membership and is a lead fitter with TaylorMade. He enjoys teaching and coaching students of all ability levels." image="" />
      </section>
    </div>
  );
}
